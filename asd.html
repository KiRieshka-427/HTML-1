...
<body class="gr">
    ...
    <header class="gr_header">
        <h1 style="background-color: darkred">ПДДМАСТЕР</h1>
    </header>

    <main class="gr_main">
        <h2 style="background-color: white">Категории и подкатегории водительских прав в 2024 году</h2>
        <img src="100212-kategorii.jpg" align="left" style="margin: 30px;" />
        <p>
        ...
        <p>
            ...
            Расшифровка категорий водительских прав приведена в следующей таблице:
        </p>

        <table>
            <tr>
                <th>Категория или подкатегория</th>
                <th>Тип транспортного средства</th>
            </tr>
            <tr>
                <th>A</th>
                <th><a href="#A">Мотоциклы</a></th>
            </tr>
            <tr>
                <th>A1</th>
                <th><a href="#A1">Легкие мотоциклы</a></th>
            </tr>
            <tr>
                <th>B</th>
                <th><a href="#B">Легковые автомобили, небольшие грузовики (до 3,5 тонн)</a></th>
            </tr>
            <tr>
                <th>BE</th>
                <th><a href="#BE">Легковые автомобили с прицепом</a></th>
            </tr>
            <tr>
                <th>B1</th>
                <th><a href="#B1">Трициклы</a></th>
            </tr>
            <tr>
                <th>C</th>
                <th><a href="#C">Грузовые автомобили (от 3,5 тонн)</a></th>
            </tr>
            <tr>
                <th>C1</th>
                <th><a href="#C1">Средние грузовики (от 3,5 до 7,5 тонн)</a></th>
            </tr>
        </table>

        <br>
        <br>
        <h2 id="A" style="background-color: white">Водительские права категории А</h2>
        <p>
        ...
        <img src="100212-a.jpg" align="left" style="margin: 30px;" />
        <p>
            Водительское удостоверение категории А позволяет управлять любыми мотоциклами, в том числе и мотоциклами с коляской.

            Кроме того, оно дает право на управление мотоколясками, которые в 2024 году на дорогах встретить чрезвычайно сложно.

            Напомню, что к мотоциклам в соответствии с ПДД относятся двухколесные транспортные средства с боковым прицепом или без него. Кроме того, категория А позволяет управлять трехколесными и четырехколесными транспортными средствами, которые в снаряженном состоянии имеют массу не более 400 кг.
        </p>

        <br>
        <br>
        <h2 id="A1" style="background-color: white">Подкатегория А1</h2>
        <p>
        ...
        <img src="100212-motocikl-kategorii-a1.jpg" align="left" style="margin: 30px;" />
        <p>
            ...
            Важное отличие подкатегории А1 состоит в том, что ее можно открыть в 16-летнем возрасте.
        </p>

        <br>
        <br>
        <h2 id="B" style="background-color: white">Водительские права категории B</h2>
        <p>
        ...
        <img src="100212-b.jpg" align="left" style="margin: 30px;" />
        <p>
            Водительское удостоверение категории В позволяет управлять легковыми автомобилями, а также небольшими грузовиками, микроавтобусами и джипами, соответствующими вышеприведенным требованиям.

            Также категория B дает право управления мотоколясками и автомобилями с прицепом, разрешенная максимальная масса которого не более 750 кг.

            Кроме того существует возможность использования и прицепов, масса которых превышает 750 килограммов, при соблюдении следующих требований:
            ...
            Например, пусть разрешенная максимальная масса автомобиля составляет 1 900 кг, а масса без нагрузки 1 400 кг (эти величины указываются в пунктах 14 и 15 паспорта транспортного средства).

            Имея удостоверение категории B можно к указанному автомобилю присоединить прицеп, разрешенная максимальная масса которого 1400 кг. В этом случае разрешенная максимальная масса прицепа не превышает массу автомобиля без нагрузки. Кроме того, разрешенная максимальная масса состава транспортных средств составляет 1 900 + 1 400 = 3 300 кг. Она не превышает 3 500 килограммов.
        </p>

        <br>
        <br>
        <h2 id="BE" style="background-color: white">BE</h2>
        <p>
        ...
        <br>
        <br>
        <h2 id="B1" style="background-color: white">Подкатегория B1</h2>
        <p>
            подкатегория "В1" - трициклы и квадрициклы;
        </p>
        <p>
            В 2023 году подробная информация по транспортным средствам категории B1 отсутствует.
        ...
        <br>
        <br>
        <h2 id="C" style="background-color: white">Водительские права категории С</h2>
        <p>
        ...
        <img src="100212_3.jpg" align="left" style="margin: 30px;" />
        <p>
            Водительские права категории С позволяют управлять только средними (от 3500 кг до 7500 кг) и тяжелыми (более 7500 кг) грузовиками, а также грузовиками с прицепом, разрешенная максимальная масса которого не превышает 750 кг.

            Обратите внимание, категория C не дает права управления небольшими (меньше 3500 кг) грузовиками и легковыми автомобилями.
        </p>

        <br>
        <br>
        <h2 id="CE" style="background-color: white">СЕ</h2>
        <p>
        ...
        <img src="100212_5.jpg" align="left" style="margin: 30px;" />
        <p>
        ...
        <br>
        <br>
        <h2 id="C1" style="background-color: white">Подкатегория С1</h2>
        <p>
        ...
        <img src="100212-gruzovik-podkategorii-c1.jpg" align="left" style="margin: 30px;" />
        <p>
            К подкатегории С1 относятся средние грузовики, разрешенная максимальная масса которых находится в интервале от 3,5 до 7,5 тонн.

            Также эта подкатегория позволяет перевозить и легкий прицеп (до 750 кг).
        ...
        <br>
        <br>
        <h2 style="background-color: white">И так далее</h2>

    </main>

    <aside class="gr_left">
        <h3 style=" background-color: white; margin-top: 100px">
            Сюда тоже можно что-нибудь поместить
        </h3>

    </aside>

    <aside class="gr_right">
        <h3 style="background-color: white">Популярные статьи</h3>
        <p>
            <ul>
                <li>
                    <a href="">Когда ставить зимнюю резину?</a>
                </li>
                <li>
                    <a href="">Штрафиы ГИБДД</a>
                </li>
                <li>
                    <a href="">Доверенность</a>
                </li>
            </ul>
        </p>
    </aside>
